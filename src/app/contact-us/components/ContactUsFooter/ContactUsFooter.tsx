...
const ContactUsFooter = ({children, className}: ICommonProps) => {
    return (
      <footer className={`lg:w-full lg:h-auto relative lg:z-50 flex justify-center md:h-[21.0625rem] md:bg-none md:items-center md:pt-0 w-full ${className}`}>
        <div className={`wrapper lg:w-full lg:h-[24.5625rem] lg:bottom-0 lg:relative lg:px-[var(--site-container-padding)] bg-[var(--site-black)] md:w-full md:px-[var(--site-tablet-container-padding)] px-[1.5rem] w-full h-full md:pb-0 md:mt-0 md:pt-0 pt-16`}>
          <section className={`lg:h-[55.14%] w-full relative z-10 flex flex-col justify-between lg:px-0 md:top-[23.73%] md:h-[41.84%]`}>
